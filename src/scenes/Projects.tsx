...
function Projects() {
  return (
    ...
    <div className="flex justify-center"><button className="text-black rounded-full white hover:text-blue-500"><BsGithub size = '3em' onClick = {()=>{window.location.href = "https://github.com/Tetlier/Atelier";}}> </BsGithub></button></div>
    </div>
    ...
    <div className="flex justify-center"><button className="text-black rounded-full white hover:text-blue-500"><BsGithub size = '3em' onClick = {()=>{window.location.href = "https://github.com/Luck-Larry/LUCKY-LARRY-S";}}></BsGithub></button></div>
    </div>
    ...
    <div className="flex justify-center"><button className="text-black rounded-full white hover:text-blue-500"><BsGithub size = '3em' onClick = {()=>{window.location.href = "https://github.com/Jesse132/SaveUp";}}></BsGithub></button></div>
    </div>
    </div>
    ...
    <div className="mt-15 flex-col">
    <b className="flex justify-center">Personal Website (TypeScript, Tailwind)</b>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/HYi96k_4Kto" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
    <p>Portfolio website that displays all my current work.</p>
    </div>
