...
function Projects() {
  return (
    <section className="md:mt-44 mt-20" id="projects">
      ...
      <div className="md:text-left text-center mt-10 mx-auto md:w-5/6 w-3/5 items-center justify-center md:flex md:space-x-20 md:h-5/6 md:space-y-0 space-y-10">

    <div className="flex-col ">
    <b className="flex justify-center">Tetlier - E-commerce Application (SERN Stack)</b>
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/ZCVLZYF9RuU" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
    ...
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/LCbKeZh7iZg" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
    ...
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/I3Sfr0sU-4M" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
    <p>A finance manager app that features a sign-up/login system with password authentication to access an account balance sheet with deposits and withdrawals to enter, a job board to submit/look for work.</p>
    ...
    <div  className="md:text-left text-center mt-10 mx-auto md:w-5/6 w-3/5 items-center justify-center md:flex md:space-x-20 md:h-1/2 md:space-y-0 space-y-10 md:flex">
      <div className="flex flex-col">
    <b className="flex justify-center">Endless Adventure (React Native)</b>
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/HYi96k_4Kto" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
    ...
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/nRLOl6rkHNg" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
